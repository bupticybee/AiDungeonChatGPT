...
story_background = "The Syndicate Continent is divided into Torre Province, Nilai Province and Mula Province, where dwarves, elves, humans and countless monsters live. You are a 21-year-old human male magician from Torre. With a staff of fire in your left hand, a magic book in your right, and a week's worth of rations in your backpack, you enter the Lykens Rainforest for an adventure."
...
class ChatApplication:
    ...
    def show_login_window(self):
        ...
        # email input
        self.email = Label(self.login, text="email：")
        ...
        # login and cancel
        self.login_btn = Button(self.login, text="Login",
    ...
    def show_api_window(self):
        ...
        # 创建一个标签
        label = Label(self.api_window, text="Please input your api_key：")
    ...
    def show_background_window(self):
        ...
        result = tkinter.simpledialog.askstring(
            title='Please input background story', prompt='Please input background story（or use default）', initialvalue=self.background,
            parent=self.window)
        if result:
    ...
    def before_start(self):
        ...
        tkinter.messagebox.showerror(
            title="The official API has been published", message="Please use the api_key to log in as much as "
                                                                 "possible, there is a risk of banning your account "
                                                                 "if you use account-password!")
    ...
    def after_get_token(self, result):
        ...
        if isinstance(result, bool) and result:
            ...
            tkinter.messagebox.showerror(
                title="Get token failed", message="Please check your email and password.")
    ...
    def _on_enter_pressed(self, event):
        ...
        thread_it(self.start_toplevel_window, "Getting response from ChatGPT")
